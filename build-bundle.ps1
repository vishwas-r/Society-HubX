# PowerShell script to build the Namma Society Webapp Bundle
...
$OUT_ZIP = Join-Path $WORKSPACE "nammasociety-webapp.zip"

Write-Host "==============================================" -ForegroundColor Cyan
Write-Host "  Namma Society - Webapp Packager  " -ForegroundColor Cyan
Write-Host "==============================================" -ForegroundColor Cyan
...
$PLUGIN_DIR = Join-Path $DIST_DIR "wp-content\plugins\nammasociety-plugin"
...
Write-Host "[7/7] Packaging into nammasociety-webapp.zip..." -ForegroundColor Green
