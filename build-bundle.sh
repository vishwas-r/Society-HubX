#!/usr/bin/env bash
# Bash script to build the Namma Society Webapp Bundle
...
OUT_ZIP="$WORKSPACE/nammasociety-webapp.zip"

echo "=============================================="
echo "  Namma Society - Webapp Packager (Bash)  "
echo "=============================================="
...
PLUGIN_DIR="$DIST_DIR/wp-content/plugins/nammasociety-plugin"
mkdir -p "$PLUGIN_DIR"
...
echo "[7/7] Packaging into nammasociety-webapp.zip..."
