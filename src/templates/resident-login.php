...
?>
<div class="sgvx-login-wrapper d-flex align-items-center justify-content-center min-vh-100">
    <!-- Animated Background -->
    <div class="sgvx-login-bg"></div>
            ...
            <div class="col-md-5">
                <div class="sgvx-login-card p-4 p-md-5">
                    ...
                    <form id="resident-login-form" method="post">
                        <?php wp_nonce_field( 'sgvx51_login_nonce', 'login_nonce' ); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', function(e) {
            ...
            formData.append('action', 'sgvx51_resident_login');
