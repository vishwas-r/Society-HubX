              ...
              <div class="card border-0 shadow-sm text-white rounded-3 h-100" style="background: #1e293b; min-height: 250px;">
                  <div class="card-body p-4 d-flex flex-column justify-content-between">
                       <div>
                           ...
                           <h2 class="display-6 fw-bold mb-0">₹<?php echo NAMMASOCIETY_in_fmt($data['current_balance']['total'] ?? 0); ?></h2>
                       </div>
                       ...
                       <div class="pt-3 border-top border-secondary">
                            <div class="row">
                                 <div class="col-6">
                                     ...
                                     <div class="fw-bold text-primary">₹<?php echo NAMMASOCIETY_in_fmt($data['current_balance']['bank'] ?? 0); ?></div>
                                 </div>
                                 <div class="col-6 border-start border-secondary">
                                     ...
                                     <div class="fw-bold text-warning">₹<?php echo NAMMASOCIETY_in_fmt($data['current_balance']['cash'] ?? 0); ?></div>
                                 </div>
                            </div>
                       </div>
                  </div>
                          ...
                          <?php else: ?>
                              <?php foreach ( ($data['detailed_expenses'] ?? []) as $ex ): ?>
                                  <tr>
                                      ...
                                      <td class="text-end pe-4 fw-bold">₹<?php echo NAMMASOCIETY_in_fmt($ex['amount'] ?? 0); ?></td>
                                  </tr>
                              <?php endforeach; ?>
                          <?php endif; ?>
                      </tbody>
