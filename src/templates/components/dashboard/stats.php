...
<div class="row g-4 mb-5">
    ...
    <div class="col-md-4">
        ...
        ?>
        <div class="card border-0 shadow-sm rounded-3 overflow-hidden h-100 transition-all hover-translate-y bg-<?php echo esc_html( $status_class ); ?> bg-opacity-10 border-start border-<?php echo esc_html( $status_class ); ?> border-4">
            <div class="card-body p-4 position-relative z-10">
                 ...
                 <div class="h2 fw-bold text-dark m-0">₹<?php echo esc_html( SHUBX_in_fmt($display_dues, 0) ); ?></div>
                  ...
                  <button data-bs-toggle="modal" data-bs-target="#SHUBX51PaymentModal" 
                          ...
                          class="js-btn-pay btn btn-<?php echo esc_html( $status_class ); ?> w-100 mt-3 py-2 rounded-3 fw-bold shadow-sm transition-all hover-translate-y">
