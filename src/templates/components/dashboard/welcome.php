    ...
    <div class="d-flex align-items-center gap-3">
        ...
        <div>
            ...
            <p class="text-secondary d-flex align-items-center gap-2 small">
                <span class="badge bg-primary-subtle text-primary px-2 py-1 rounded fw-semibold text-uppercase tracking-wide">Flat <?php echo esc_html( Society_GoVernX::get_instance()->db->get_flat_display_name( $r['flat_no'] ?? '' ) ); ?></span>
