 ...
 */
$poll_mgr = new NAMMASOCIETY51_Poll_Manager();
$all_polls = (new NAMMASOCIETY51_DB_Router())->get('polls');
$r = $data['resident'] ?? [];
?>
<!-- 6. POLLS TAB -->
                        ...
                        <div id="poll-container-<?php echo esc_attr($p['id']); ?>">
                            ...
                            <div class="js-poll-form <?php echo $has_voted ? 'd-none' : ''; ?>">
                                <form action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" method="POST" class="js-poll-vote-form" data-poll-id="<?php echo esc_attr($p['id']); ?>">
                                    <input type="hidden" name="action" value="nammasociety51_cast_vote">
                                    <input type="hidden" name="poll_id" value="<?php echo esc_attr($p['id']); ?>">
                                    <?php wp_nonce_field('nammasociety51_vote_nonce'); ?>
