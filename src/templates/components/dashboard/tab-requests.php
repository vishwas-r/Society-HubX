    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="d-flex justify-content-between align-items-center mb-4 text-start">
                ...
                <button class="btn btn-primary d-flex align-items-center gap-2 px-4 shadow-sm" data-bs-toggle="modal" data-bs-target="#NAMMASOCIETY51GeneralRequestModal">
                ...
                <?php else : ?>
                    <?php foreach ( $data['my_requests'] as $req ) : ?>
                        ...
                        <div class="bg-white rounded-3 shadow-sm border border-light p-4 position-relative ps-4 text-start">
                             <!-- Accent Line -->
                            <div class="position-absolute start-0 top-0 bottom-0 <?php echo esc_html( str_replace('bg-opacity-10', '', $status_class) ); ?> rounded-start" style="width: 4px;"></div>
                            ...
                            <div class="d-flex justify-content-between align-items-start mb-2 ps-2">
                                <div>
                                    <div class="d-flex align-items-center gap-2 mb-1">
                                        ...
                                        <span class="badge rounded-pill fw-normal <?php echo esc_html( $status_class ); ?>" style="font-size: 0.7rem;">
                                            <i class="bi <?php echo esc_html( $status_icon ); ?> me-1"></i> <?php echo esc_html( ucfirst($status) ); ?>
                                        </span>
                                    </div>
                                    <small class="text-muted font-monospace">ID: #<?php echo esc_html(substr($req['id'], -8)); ?></small>
                                </div>
                                <div class="text-end">
                                    <span class="badge bg-light text-muted fw-normal border border-light d-block mb-2"><?php echo esc_html( wp_date( 'd M Y, h:i A', strtotime( $req['created_at'] ) ) ); ?></span>
