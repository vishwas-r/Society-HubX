                  ...
                  <div class="position-relative z-10">
                      <div class="d-flex justify-content-between align-items-start">
                          <div>
                              ...
                              <h2 class="display-6 fw-bold m-0">₹<?php echo esc_html( NAMMASOCIETY_in_fmt($display_dues, 0) ); ?></h2>
                          </div>
              ...
              <div class="bg-white rounded-3 shadow-sm border border-light p-4 h-100">
                  ...
                  <ul class="list-unstyled m-0 d-flex flex-column gap-3">
                       <li class="d-flex justify-content-between border-bottom border-light pb-2">
                           ...
                           <span class="fw-bold text-dark small">₹<?php echo esc_html( NAMMASOCIETY_in_fmt($total_dues, 0) ); ?></span>
                       </li>
                       <li class="d-flex justify-content-between border-bottom border-light pb-2">
                           <span class="text-secondary small">Pending Verification</span>
                           <span class="fw-bold text-info small">- ₹<?php echo esc_html( NAMMASOCIETY_in_fmt($pending_payment_total, 0) ); ?></span>
                       </li>
                       <li class="d-flex justify-content-between">
                           <span class="text-dark small fw-bold">Current Outstanding</span>
                           <span class="fw-bold text-primary small">₹<?php echo esc_html( NAMMASOCIETY_in_fmt($display_dues, 0) ); ?></span>
                       </li>
                   </ul>
              </div>
         </div>
                      ...
                      <?php else: ?>
                          <?php foreach ( $all_payments as $pay ) : ?>
                            <tr>
                                ...
                                <td class="font-monospace <?php echo ($pay['status'] === 'pending') ? 'text-secondary' : 'text-success'; ?> fw-bold">₹<?php echo esc_html( NAMMASOCIETY_in_fmt($pay['amount'], 0) ); ?></td>
                                <td>
