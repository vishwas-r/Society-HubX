...
function renderNoticeList($list, $empty_title, $empty_msg) {
    ...
    <?php else : ?>
        <div class="d-flex flex-column gap-4">
            ...
            ?>
                <div class="card <?php echo esc_html( $border_class ); ?> <?php echo esc_html( $glow_class ); ?> shadow-sm rounded-3 overflow-hidden bg-white nammasociety-notice-card" 
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="d-flex gap-4 pt-2">
                                <label class="nammasociety-toggle">
                                    <input type="checkbox" name="is_pinned" id="n-pinned" value="1">
                                    <span class="nammasociety-toggle-slider"></span>
                                </label>
