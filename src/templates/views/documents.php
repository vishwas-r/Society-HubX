 ...
 * Integrates with NAMMASOCIETY51_Drive_Manager and NAMMASOCIETY51_DB_Router.
 */

$db = new NAMMASOCIETY51_DB_Router();
$drive = new NAMMASOCIETY51_Drive_Manager();
        ...
        <div class="row g-0 h-100">
            ...
            <div class="col-md-3 border-end border-light flex-column d-flex h-100">
                <div class="flex-grow-1 overflow-y-auto" id="residentList" style="max-height: 600px;">
                    ...
                    ?>
                         <a href="?page=nammasociety51-documents&flat=<?php echo esc_url( urlencode( $flat_no ) ); ?>" 
...
add_action('nammasociety51_admin_modals', function() use ($selected_flat) {
?>
<!-- Upload Modal -->
        ...
        <div class="modal-content border-0 shadow-lg rounded-3">
            ...
            <form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" enctype="multipart/form-data" id="upload-form">
                <div class="modal-body p-4">
                    ...
                    <?php wp_nonce_field( 'nammasociety51_upload_doc_nonce' ); ?>
