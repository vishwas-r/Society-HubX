 ...
 * Integrates with SHUBX51_Drive_Manager and SHUBX51_DB_Router.
 */

$db = new SHUBX51_DB_Router();
$drive = new SHUBX51_Drive_Manager();
...
add_action('shubx51_admin_modals', function() use ($selected_flat) {
?>
<!-- Upload Modal -->
        ...
        <div class="modal-content border-0 shadow-lg rounded-3">
            ...
            <form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" enctype="multipart/form-data" id="upload-form">
                <div class="modal-body p-4">
                    ...
                    <?php wp_nonce_field( 'shubx51_upload_doc_nonce' ); ?>
