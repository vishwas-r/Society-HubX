 ...
 * Integrates with SHUBX51_DB_Router for real statistics.
 */
            ...
            <div class="card border-0 shadow-sm rounded-3 bg-primary bg-opacity-10 border border-primary border-opacity-10 overflow-hidden">
                <div class="p-4 p-md-5 d-flex flex-column h-100">
                    ...
                    <div class="d-flex flex-column gap-3">
                        <a href="?page=shubx51-notices" class="btn btn-white text-start py-3 px-4 d-flex align-items-center gap-3 rounded-3 border-0 shadow-sm transition-all hover-translate-y">
                            <i class="bi bi-megaphone text-primary fs-5"></i>
                            <span class="fw-bold text-dark small">Publish Notice</span>
                        </a>
                        <a href="?page=shubx51-residents" class="btn btn-white text-start py-3 px-4 d-flex align-items-center gap-3 rounded-3 border-0 shadow-sm transition-all hover-translate-y">
                            <i class="bi bi-person-plus text-primary fs-5"></i>
                            <span class="fw-bold text-dark small">Add Resident</span>
                        </a>
                        <a href="?page=shubx51-expenses" class="btn btn-white text-start py-3 px-4 d-flex align-items-center gap-3 rounded-3 border-0 shadow-sm transition-all hover-translate-y">
                            <i class="bi bi-plus-square text-primary fs-5"></i>
                            <span class="fw-bold text-dark small">Record Expense</span>
                        </a>
                        <a href="?page=shubx51-facilities" class="btn btn-white text-start py-3 px-4 d-flex align-items-center gap-3 rounded-3 border-0 shadow-sm transition-all hover-translate-y">
