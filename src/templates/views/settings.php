                        ...
                        <div class="accordion-item border-0 mb-3 shadow-sm rounded-4 overflow-hidden">
                            ...
                            <div id="collapseChannels" class="accordion-collapse collapse show" data-bs-parent="#communicationAccordion">
                                <div class="accordion-body p-4 bg-slate-50">
                                    <div class="row g-4">
                                        <?php 
                                        $channel_slugs = !empty($channels) ? array_column($channels, 'channel_slug') : [];
                                        ...
                                        <div class="col-12 col-sm-6 col-xl-3">
                                            <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden nammasociety-channel-card">
                                                <div class="card-body p-4 d-flex flex-column">
                                                    ...
                                                    <h6 class="fw-bold text-slate-900 mb-1"><?php echo esc_html( $channel_title ); ?></h6>
                                        ...
                                        <table class="table table-hover align-middle mb-0 small">
                                            <thead class="bg-light bg-opacity-50 border-bottom">
                                                <tr>
                                                    ...
                                                    <th class="py-3 fw-bold text-slate-500 text-center text-uppercase">Push</th>
                                                </tr>
                                            </thead>
                                            <tbody>
