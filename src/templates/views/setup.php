...
/**
 * View: Setup Wizard
 * A premium, multi-step installer for Namma Society.
 */
...
$society_name = get_option('nammasociety51_society_name', '');
?>
        ...
        <div class="row g-0">
            ...
            <div class="col-md-4 bg-dark text-white p-5 d-flex flex-column justify-content-between">
                <div>
                    <div class="d-flex align-items-center gap-2 mb-4">
                        ...
                        <h5 class="fw-bold mb-0">Namma Society</h5>
                    </div>
                ...
                <div class="small text-white-50">
                    &copy; <?php echo esc_html( wp_date('Y') ); ?> Namma Society
                </div>
            </div>
            ...
            <div class="col-md-8 p-5">
                <form method="post" action="admin-post.php" enctype="multipart/form-data">
                    <?php wp_nonce_field('nammasociety51_setup_nonce'); ?>
                    <input type="hidden" name="action" value="nammasociety51_setup_action">
                    
                    <?php if($step == 1): ?>
                        <input type="hidden" name="nammasociety51_setup_step" value="identity">
                        <div class="mb-4">
                    ...
                    <?php elseif($step == 2): ?>
                        <input type="hidden" name="nammasociety51_setup_step" value="property">
                        <div class="mb-4">
                    ...
                    <?php elseif($step == 3): ?>
                        <input type="hidden" name="nammasociety51_setup_step" value="financials">
                        <div class="mb-4">
                    ...
                    <?php elseif($step == 4): ?>
                        <input type="hidden" name="nammasociety51_setup_step" value="finalize">
                    ...
                    <div class="mt-5 d-flex justify-content-between align-items-center pt-4 border-top border-light">
                        <?php if($step > 1 && $step < 4): ?>
                            <a href="?page=nammasociety51-setup&step=<?php echo esc_html( $step - 1 ); ?>" class="btn btn-link text-secondary text-decoration-none fw-semibold">
                    ...
                    <?php if($step < 4): ?>
                    <input type="hidden" name="_wp_http_referer" value="<?php echo esc_url(add_query_arg('step', $step + 1, admin_url('admin.php?page=nammasociety51-setup'))); ?>">
                    <?php endif; ?>
                </form>
            </div>
        </div>
