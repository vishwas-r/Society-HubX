            ...
            <div class="card border-0 shadow-sm rounded-3 mb-5 overflow-hidden bg-white p-0">
                ...
                <div class="p-4">
                    <form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" id="facility-form">
                        <input type="hidden" name="action" value="nammasociety51_add_facility">
...
add_action('nammasociety51_admin_modals', function() use ($facilities, $residents) {
?>
<!-- Booking Modal -->
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content border-0 shadow-lg rounded-3">
            ...
            <div class="modal-footer border-0 p-4 pt-0 gap-2">
                ...
                <button type="button" id="confirm-delete-booking-btn" class="btn btn-danger flex-grow-1 fw-bold rounded-3 py-2 shadow-none">Confirm Delete</button>
            </div>
        </div>
    </div>
</div>
