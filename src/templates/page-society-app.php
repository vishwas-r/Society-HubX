 ...
 * Description: A full-width, SaaS-style template for Namma Society pages.
 */
...
?><!DOCTYPE html>
<html <?php language_attributes(); ?> data-bs-theme="<?php echo esc_attr( $current_theme ); ?>" data-nammasociety-palette="<?php echo esc_attr( $current_palette ); ?>">
<head>
...
<body <?php body_class('shadow-none'); ?>>
    ...
    <!-- App Header -->
    <header class="nammasociety-top-header d-flex align-items-center justify-content-between px-3 px-lg-5 bg-white border-bottom sticky-top shadow-sm" style="height: 72px; z-index: 1050;">
        <div class="d-flex align-items-center gap-3">
            <button id="nammasociety-sidebar-toggle" class="btn btn-outline-secondary border-0 p-1 d-flex align-items-center justify-content-center hover-bg-slate-50 d-lg-none" style="width: 40px; height: 40px;">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            if ( is_user_logged_in() ) : 
                ...
                $resident = NAMMASOCIETY51_Plugin::get_instance()->db->get_resident_by_wp_id( $current_user->ID );
