...
class NAMMASOCIETY51_Admin_Requests {
	...
	public function __construct() {
		...
		add_action( 'admin_post_nammasociety51_approve_request', array( $this, 'handle_approve' ) );
		add_action( 'admin_post_nammasociety51_reject_request', array( $this, 'handle_reject' ) );
	}
	...
	public function handle_approve() {
		...
		check_admin_referer( 'nammasociety51_request_action' );
		...
		if ( $redirect ) {
			...
			wp_safe_redirect( admin_url( 'admin.php?page=nammasociety51-requests&status=approved' ) );
		}
		exit;
	}
	...
	public function handle_reject() {
		...
		if ( $redirect ) {
			...
			wp_safe_redirect( admin_url( 'admin.php?page=nammasociety51-requests&status=rejected' ) );
		}
		exit;
	}
	...
	public function render_page() {
		...
		NAMMASOCIETY51_Admin_App::render_view( 'requests', array( 'requests' => $decorated_requests ) );
	}
}
