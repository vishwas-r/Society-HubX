...
class SNESTX51_Admin_Requests {
	...
	public function handle_approve() {
		...
		if ( $redirect ) {
			...
			wp_safe_redirect( admin_url( 'admin.php?page=snestx51-requests&status=approved' ) );
		}
		exit;
	}
	...
	public function handle_reject() {
		...
		if ( $redirect ) {
			...
			wp_safe_redirect( admin_url( 'admin.php?page=snestx51-requests&status=rejected' ) );
		}
		exit;
	}
	...
	public function render_page() {
		...
		SNESTX51_Admin_App::render_view( 'requests', array( 'requests' => $decorated_requests ) );
	}
}
