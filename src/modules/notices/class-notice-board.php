...
class NAMMASOCIETY51_Notice_Board {
	...
	public function __construct() {
        ...
        // AJAX Handlers
        add_action( 'wp_ajax_nammasociety51_add_notice', array( $this, 'ajax_save_notice' ) );
        add_action( 'wp_ajax_nammasociety51_update_notice', array( $this, 'ajax_save_notice' ) );
        add_action( 'wp_ajax_nammasociety51_delete_notice', array( $this, 'ajax_delete_notice' ) );
        add_action( 'wp_ajax_nammasociety51_toggle_pin', array( $this, 'ajax_toggle_pin' ) );
        add_action( 'wp_ajax_nammasociety51_get_notice', array( $this, 'ajax_get_notice' ) );
	}
	...
	public function render_page() {
		...
		NAMMASOCIETY51_Admin_App::render_view('notices');
	}
    ...
    public function ajax_get_notice() {
        check_ajax_referer('nammasociety51_notice_nonce', '_wpnonce');
    ...
    public function ajax_delete_notice() {
        check_ajax_referer('nammasociety51_delete_notice_nonce', '_wpnonce');
    ...
    private function broadcast_notice($notice) {
        ...
        $dispatcher = NAMMASOCIETY51_Plugin::get_instance()->notifications;
