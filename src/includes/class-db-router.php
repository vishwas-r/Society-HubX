...
class SGVX51_DB_Router {
	 ...
	 */
	const TABLES = array( 'meta', 'flats', 'residents', 'vehicles', 'facilities', 'bookings', 'assets', 'notices', 'expenses', 'documents', 'daily_help', 'invoices', 'receipts', 'polls', 'votes', 'resident_history', 'requests' );
