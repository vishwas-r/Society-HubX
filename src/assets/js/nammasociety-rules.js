/**
 * NAMMASOCIETY Rules Management JS
 */
(function ($) {
    'use strict';
    ...
    window.handleRuleSubmit = function (e) {
        ...
        NAMMASOCIETY.ajax({
            action: isEdit ? 'nammasociety51_edit_rule' : 'nammasociety51_add_rule',
    ...
    window.publishRule = async function (ruleId) {
        ...
        NAMMASOCIETY.ajax({
            action: 'nammasociety51_publish_rule',
            data: {
                rule_id: ruleId,
    ...
    window.deleteRule = async function (ruleId) {
        ...
        NAMMASOCIETY.ajax({
            action: 'nammasociety51_delete_rule',
            data: {
                rule_id: ruleId,
                _wpnonce: Config.nonce
            },
    ...
    window.viewVersionHistory = async function (ruleId) {
        ...
        NAMMASOCIETY.ajax({
            action: 'nammasociety51_get_version_history',
            data: {
                rule_id: ruleId,
                _wpnonce: Config.nonce
            },
    ...
    window.handleCategorySubmit = function (e) {
        ...
        NAMMASOCIETY.ajax({
            action: 'nammasociety51_manage_category',
            data: Object.fromEntries(formData),
            loadingButton: $(e.target).find('button[type="submit"]'),
    ...
    window.resolveViolation = async function (violationId) {
        ...
        NAMMASOCIETY.ajax({
            action: 'nammasociety51_resolve_violation',
            data: {
    ...
    window.sendReminders = async function () {
        ...
        NAMMASOCIETY.ajax({
            action: 'nammasociety51_send_acknowledgment_reminders',
            data: {
                _wpnonce: Config.nonce
            },
